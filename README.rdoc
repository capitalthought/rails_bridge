...
This issues an HTTP GET to "http://server.com:8080/some/path?param1=a%20value&param2=another%20value" and returns the content.  If the server is unavailable, returns an error, or if the request times out, the default content is returned instead.
